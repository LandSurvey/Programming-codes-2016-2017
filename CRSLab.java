/*
*This program does coordinate transformation
...
public class CRSLab {
    ...
    //METHOD displays shapefiles when added to the layer
     ...
     //An action button that validates the geometry of the added vector data
      class ValidateGeometryAction extends SafeAction {
        ...
        //an action button that exports shapefile with the transformed coordinate system
        ...
        //Method to save the the shapefile with transformed coordiantes
public void exportToShapefile() throws Exception {
        ...
        //code for transforming the coordinates
